            ...
            if key == .globalPosts {
                ...
                if case let .forum(peerId) = location {
                    ...
                    if case let .chatList(groupId) = location, case .archive = groupId {
                        searchLocations = [.general(scope: .everywhere, groupId: groupId._asGroup(), tags: tagMask, minDate: options.date?.0, maxDate: options.date?.1, folderId: nil)]
                    } else {
                ...
                if case .channels = key {
                    ...
                    searchLocations = [.general(scope: .everywhere, groupId: groupId._asGroup(), tags: tagMask, minDate: nil, maxDate: nil, folderId: nil)]
                } else {
