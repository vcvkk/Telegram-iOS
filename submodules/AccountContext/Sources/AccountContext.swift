...
public protocol SharedAccountContext: AnyObject {
    ...
    func makeEGProController(context: AccountContext) -> ViewController
    func makeEGPayWallController(context: AccountContext) -> ViewController?
    func makeEGUpdateIOSController() -> ViewController
    ...
    func makeEditForumTopicScreen(context: AccountContext, peerId: EnginePeer.Id, threadId: Int64, threadInfo: TelegramCore.EngineMessageHistoryThread.Info, isHidden: Bool) -> ViewController
    ...
    func makeCreateChannelController(context: AccountContext, completion: @escaping (PeerId, @escaping () -> Void) -> Void) -> ViewController
